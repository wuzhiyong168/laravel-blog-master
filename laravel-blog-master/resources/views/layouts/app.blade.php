...
<body>
    <div id="app">
        <nav class="navbar navbar-default navbar-static-top z-navBar-bottom-line">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        {{--<li><a href="https://github.com/wuzhiyong168" target="_blank">Git <img src="/images/api/github.png" alt="" style="width:18px;margin-bottom:3px"></a></li>--}}
                    </ul>
